"""doctsring for installed packages."""
import os
import datetime
import logging
import numpy as np
...
class MetricPredictor:
    ...
    model_name = "SARIMA"
    model_description = "Forecasted value from SARIMA model"
    model = None
    predicted_df = None
    metric = None
    ...
    def train(self, metric_data=None, prediction_duration=15, freq="1h"):
        ...
        forecast_values = self.sarima_driver(vals, prediction_duration, sfrequency)
